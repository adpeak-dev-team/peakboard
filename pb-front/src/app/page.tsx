  ...
  return (
    <div className="flex h-screen bg-gray-50 font-sans text-gray-800 overflow-hidden">
      ...
      <TodoListModal
        ...
        onAddTodo={() =>
          viewingTaskId &&
          setAddTodoTarget({ kind: 'task', id: viewingTaskId })
        }
        onToggleStar={(todoId) =>
          viewingTaskId &&
        ...
        onRequestMove={(todoId) =>
          viewingTaskId &&
          setMovingTodo({ source: { kind: 'task', id: viewingTaskId }, todoId })
        }
      ...
      <FolderModal
        ...
        onRequestMove={(todoId) =>
          viewingFolderId &&
          setMovingTodo({ source: { kind: 'folder', id: viewingFolderId }, todoId })
        }
        onRequestCopy={(todoId) =>
          viewingFolderId &&
          setCopyingTodo({ source: { kind: 'folder', id: viewingFolderId }, todoId })
        }
